CLASS zkat2_cl_bp_query_provider DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_business_partner_range TYPE RANGE OF zkat2_sepm_i_businesspartner_e-BusinessPartner.
    TYPES t_business_data TYPE TABLE OF zkat2_sepm_i_businesspartner_e.
...
CLASS zkat2_cl_bp_query_provider IMPLEMENTATION.
  ...
  METHOD get_business_partners.
    ...
    http_client->get_http_request( )->set_authorization_basic( i_username = 'P2004545589'
                                                               i_password = 'Password42es5' ).

    service_consumption_name = to_upper( 'ZKAT2_SC_BUSINESS_PARTNER' ).
    ...
    read_list_request = odata_client_proxy->create_resource_for_entity_set( 'SEPM_I_BUSINESSPARTNER_E' )->create_request_for_read( ).
